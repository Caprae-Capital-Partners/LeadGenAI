            ...
            <div className="space-y-6">
              ...
              <div>
               ...
               <div>
                ...
                <p className="text-muted-foreground">
                Lead enrichment/enhancement means adding valuable contact information and business details to your basic lead data. Our platform enriches leads by adding details such as email addresses, phone numbers, and other professional information using services like Apollo and Grojo.
                </p>
              </div>
            </div>
          </div>
