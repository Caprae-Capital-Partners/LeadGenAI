              ...
              <div className="w-full lg:w-1/2 relative">
                ...
                >
                  <div className="absolute inset-0 flex items-center justify-center z-10">
                    ...
                    >
                      <Play className="h-9 w-9 text-black ml-1" /> {/* Added ml-1 to center the triangle visually */}
                    </Button>
                  </div>
                  <Image
                ...
                <div className="w-full relative z-10">
                  {isSuccess ? (
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-400 text-center mb-2.5">Be the first to know when we launch</p>
                      ...
                      <div className="space-y-1.5">
                        ...
                        <Input
                          ...
                          className="h-10 rounded-md bg-[#1A2438]/70 border-[#2A3A59]/50 focus:border-[#6366F1] focus:ring-[#6366F1] transition-all text-yellow-400 placeholder:text-yellow-400/50 px-4" /* Added px-4 for better padding */
